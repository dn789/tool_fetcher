...
class RoSTERUtils(object):
    ...
    def read_file(self, file_dir="conll", dataset_name="train"):
        ...
        label_file = os.path.join(file_dir, f"{dataset_name}_labels.txt")
    ...
    def get_data(self, dataset_name):
        sentences, labels = self.read_file(
    ...
    def get_tensor(self, dataset_name, max_seq_length, drop_o_ratio=0):
        data_file = os.path.join(
            self.data_dir, f"{dataset_name}.pt")
