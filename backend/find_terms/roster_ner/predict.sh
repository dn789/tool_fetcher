...
python -u src/roster_test.py --data_dir data/$CORPUS --output_dir $OUT_DIR --temp_dir $TEMP_DIR \
    --pretrained_model roberta-base --tag_scheme 'io' --max_seq_length 120 \
    --train_batch_size 32 --gradient_accumulation_steps 8 --eval_batch_size 64 \
    --noise_train_lr 3e-5 --ensemble_train_lr 1e-5 --self_train_lr 5e-7 \
    --noise_train_epochs 2 --ensemble_train_epochs 2 --self_train_epochs 2 \
    ...
    --do_train --do_eval --eval_on "customtest" | tee $OUT_DIR/train_log.txt